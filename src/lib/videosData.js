// Videos centralizados - pueden ser usados en blog posts y productos
export const videos = [
  // Betta Videos
  {
    id: "betta-taninos",
  ...
  },
  {
    ...
    emoji: "🏠",
    tags: ["betta", "setup", "acuario"],
  },
  {
    id: "betta-hojas-almendro",
    name: "Hojas de Almendro",
    url: {
      tiktok: "https://www.tiktok.com/@juanjoeltiopez/video/7421008955045989638",
      instagram: "https://www.instagram.com/p/DAjdcHUy2BW/",
    },
    emoji: "🍃",
    tags: ["betta", "hojas-almendro", "botanicals"],
  },
  {
    id: "betta-botanicos",
    ...
    url: {
      ...
      instagram: "https://www.instagram.com/p/DD20edySgdz/",
    },
    emoji: "🍂",
    tags: ["betta", "botanicals"],
  },
  {
    id: "betta-compatibles",
    name: "Peces compatibles con mi Betta",
    url: {
      tiktok: "https://www.tiktok.com/@juanjoeltiopez/video/7451448101975395589",
      instagram: "https://www.instagram.com/p/C90oSP7y3qt/",
    },
    emoji: "🐠",
    tags: ["betta", "compatibilidad", "comunitario"],
  },
  {
    id: "betta-entrena",
    ...
    emoji: "🎯",
    tags: ["betta", "entrenamiento"],
  },

  // Gambitas/Camarones Videos
  {
    id: "gambitas-5-consejos",
    ...
    emoji: "🤚🏻",
    tags: ["gambitas", "consejos", "cuidado"],
  },
  {
    id: "gambitas-alimento-premium",
  ...
  },
  {
    ...
    emoji: "🍭",
    tags: ["gambitas", "snacks", "alimentacion"],
  },
  {
    id: "gambitas-3-tips",
  ...
  // Mantenimiento Videos
  {
    ...
    emoji: "🟢",
    tags: ["mantenimiento", "algas"],
  },
  {
    id: "mantenimiento-betta",
    ...
    emoji: "🧹",
    tags: ["mantenimiento", "betta"],
  },
  {
    id: "mantenimiento-plantado",
  ...
  // Caridinas Videos
  {
    ...
    emoji: "🛠️",
    tags: ["caridinas", "setup", "gambario"],
  },
  {
    id: "caridinas-ciclado",
    ...
    emoji: "🔄",
    tags: ["caridinas", "ciclado"],
  },
  {
    id: "caridinas-microfauna",
    ...
    emoji: "🔬",
    tags: ["caridinas", "microfauna"],
  },
  {
    id: "caridinas-plantando",
  ...
  },
  {
    ...
    emoji: "🟢",
    tags: ["caridinas", "algas"],
  },
  {
    id: "caridinas-primeros-inquilinos",
    ...
    emoji: "🏠",
    tags: ["caridinas", "setup"],
  },
  {
    id: "caridinas-pure-line",
  ...
  },
  {
    ...
    emoji: "✨",
    tags: ["caridinas", "evolucion"],
  },

  // Plantas Videos
  {
    id: "plantas-no-plastico",
    ...
    emoji: "🚫",
    tags: ["plantas", "naturaleza"],
  },
  {
    id: "plantas-montaje-betta",
    ...
    emoji: "🏗️",
    tags: ["plantas", "betta", "setup"],
  },
  {
    id: "plantas-adios-artificial",
  ...
  {
    id: "plantas-anubias-bucephalandras",
    ...
    emoji: "🌱",
    tags: ["plantas", "anubias", "bucephalandras", "principiantes"],
  },

  // Paisajismo Videos
  {
    id: "paisajismo-primer-concurso",
    ...
    emoji: "🏆",
    tags: ["paisajismo", "concurso"],
  },
  {
    id: "paisajismo-hardscape",
    ...
    emoji: "🪨",
    tags: ["paisajismo", "hardscape", "concurso"],
  },
  {
    id: "paisajismo-detalles",
  ...
  },
  {
    ...
    emoji: "🔄",
    tags: ["paisajismo", "ciclado", "concurso"],
  },
  {
    id: "paisajismo-peces",
    ...
    emoji: "🐟",
    tags: ["paisajismo", "peces", "concurso"],
  },
  {
    id: "paisajismo-nuevo",
...
export function getVideosByIds(ids) {
  ...
  return ids.map(id => getVideoById(id)).filter(Boolean);
}

export function getVideosByTag(tag) {
  return videos.filter(video => video.tags && video.tags.includes(tag));
}
