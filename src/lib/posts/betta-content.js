...
**Recomendaciones:**
- Mínimo: 15 litros (ideal 20+ litros)
- Evita peceras pequeñas tipo "betteras"
- Más espacio = pez más feliz y saludable
...
**Importante:**
- Usa un calentador de calidad con termostato
- Verifica la temperatura diariamente
- Evita fluctuaciones bruscas
...
**Características del filtro ideal:**
- Flujo ajustable o suave
- Medios filtrantes: esponjas (filtración mecánica y biológica)
- Canutillos cerámicos (colonización de bacterias beneficiosas)
- Evita corrientes fuertes que estresen al pez
- El filtro mantiene el agua limpia y oxigenada
...
- **Anubias** - Resistentes, hojas anchas para descansar
- **Bucephalandras** - Compactas y hermosas
- **Helecho de Java** - Fácil de mantener
- **Musgo de Java** - Crea refugios naturales
- **Vallisneria** - Proporciona cobertura vertical

**Beneficios:**
- Oxigenan el agua
- Absorben nitratos
- Proporcionan escondites y seguridad
...
- **Cantidad:** 2-3 pellets, 1-2 veces al día
- **Variedad:** Pellets de calidad + alimento vivo/congelado
- **Alimentos vivos/congelados:** Artemia, larvas de mosquito, daphnia
- **Ayuno:** 1 día por semana
- **Tiempo:** Solo lo que coman en 2-3 minutos
- Retira comida no consumida
...
**Buenos Compañeros:**
- **Corydoras** - Peces de fondo pacíficos
- **Otocinclus** - Comedores de algas pequeños
- **Caracoles** (Nerite, Mystery)
- **Camarones** - Con precaución, depende del temperamento
- **Rasboras** - Peces pequeños y rápidos

**Evita:**
- Otros Bettas (especialmente machos)
- Peces con aletas largas (guppys, goldfish)
- Peces agresivos o muy activos
- Peces mordedores de aletas
- Tetras agresivos
...
- **Cambios de agua:** 25-30% semanalmente
- **Sifonado:** Limpia el sustrato regularmente
- **Pruebas de agua:** Semanalmente
- **Acondicionador:** Siempre trata el agua nueva
...
**Importante:** Agua limpia = Betta saludable. El amoníaco y los nitritos son tóxicos incluso en pequeñas cantidades.

## Señales de un Betta Saludable

- Colores vibrantes y brillantes
- Aletas completas, sin desgarros
- Activo y curioso
- Buen apetito
- Nada con energía
- Construye nidos de burbujas (señal de bienestar)
- Interactúa contigo

## Conclusión

Los Bettas son peces increíbles que pueden vivir 3-5 años (o más) con los cuidados adecuados. No son peces para peceras pequeñas - merecen un acuario apropiado con calentador, filtro y plantas.

**Recuerda:** No es lo mismo que sobrevivan a que vivan bien. Dale a tu Betta el hogar que merece y te recompensará con su belleza, personalidad y años de compañía.

¡Un Betta feliz es un Betta saludable!
`;
