export default `
Las gambitas de acuario son diminutas criaturas pero llenas de carácter y ternura que pueden ser un verdadero espectáculo en tu acuario.
...
La decoración del acuario no es solo estética, es fundamental para el bienestar de tus gambitas. Decora el acuario con **musgos** como musgo de Java o Christmas Moss, y plantas como **Anubias** y **Bucephalandras**. Estas plantas proporcionan refugio, mejoran la calidad del agua y fomentan la actividad natural de las gambitas.

![Musgos y anubias en gambario](/images/gambas-consejos/musgos-anubias-gambas.jpg)
*Musgos como el musgo de Java y plantas epífitas como anubias crean el ambiente ideal para tus gambitas, ofreciendo refugio y zonas de pastoreo*
