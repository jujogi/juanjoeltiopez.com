export default `
Las caridinas son unas de las especies de gambas más fascinantes que puedes tener en el acuario, sin embargo requieren de cuidados especiales debido a su delicadeza en comparación con sus hermanas, **las neocaridinas**.

A continuación, te comparto el proceso que estoy siguiendo para montar este gambario, el cual ha causado tanto revuelo en redes 😅.

## Caridinas y sus necesidades
...
![Sustrato nutritivo para gambario](/images/gambario-caridinas/sustrato-nutritivo.jpg)
*Sustrato activo Brightwell Aquatics, clave para mantener el pH ácido ideal para caridinas*

## Sobrefiltración

Una sobrefiltración es muy importante para garantizar un agua cristalina y libre de compuestos nitrogenados como el amonio y los nitritos, que son **altamente tóxicos** para nuestras futuras gambas caridinas. Para este proyecto estoy utilizando un filtro tipo **Side Sump**, el cual tiene gran capacidad para albergar material biológico, como canutillos y piedra pomez (Matrix).
...
- Urna de 60cm largo x 30cm ancho x 27cm alto con Side Sump.
- Lámpara **Chihiros WRGB 2 Slim** de 60cm.
- Sustrato nutritivo de la marca **Brightwell Aquatics**.
- Hardscape elaborado con **Roca Volcánica**.
- Plantas:
  - **Tapizantes:** Eleocharis, Micranthemum MonteCarlo y Hydrocotyle tripartita.
  - **Epífitas:** Bucephalandras de diversas especies.
  - **Flotantes:** Lechuga de agua.

![Plantas en el gambario](/images/gambario-caridinas/plantas-gambario.jpg)
*Plantas tapizantes y epífitas estableciéndose en el gambario, creando el ambiente perfecto para las caridinas*
`;
