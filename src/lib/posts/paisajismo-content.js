...
- 🌴 En la parte trasera, utiliza un sustrato nutritivo que sirva como base para plantas de tallo. Estas plantas crecen rápidamente y ayudarán a dar profundidad al acuario.
- ☘️ En la parte delantera, puedes optar por un sustrato inerte como piedra de río o arena (así ahorras un poco de dinero), ideal para plantas epífitas como Anubias y Bucephalandras que no necesitan enterrarse y pueden adherirse a rocas o troncos, añadiendo un toque natural y elegante al diseño.

**¡Cuidado con las rocas y troncos!**

- 🪨 Algunas rocas, como la **Seiryu**, pueden alterar los parámetros del agua al liberar carbonatos que aumentan la dureza y el pH.
- 🪵 Los troncos suelen liberar **taninos**, los cuales tiñen el agua de un color marrón. Aunque este efecto es natural y puede ser beneficioso para ciertos peces, si prefieres agua cristalina, puedes solucionarlo utilizando productos como Purigen en tu sistema de filtración.
...
- **🌴 Zona trasera**: Perfectas para plantas de tallo que crecen rápido y añaden volumen al paisaje, como Rotala rotundifolia, Hygrophila polysperma y Ludwigia repens.
- **🌱 Zona media**: Opta por plantas de tamaño medio que añadan transición, como las Cryptocoryne, Bacopa caroliniana o Staurogyne repens.
- **🪷 Zona delantera**: Las plantas tapizantes son ideales para crear un efecto de césped, como Monte Carlo o Eleocharis.
- **🗿 Troncos y rocas**: Anubias, Bucephalandras y Helechos de Java son perfectos para adherirse a superficies duras y aportar un toque natural.

## Mantenimientos

Los mantenimientos son necesarios en cualquier proyecto acuático, especialmente en las primeras semanas:

- **💦 Cambios de agua frecuentes:** Durante los primeros días y semanas, realiza cambios de agua parciales (30-50%) al menos 2-3 veces por semana. Esto ayuda a combatir las algas que podrían surgir por los nutrientes liberados por el sustrato nutritivo.
- **✂️ Podas regulares:** A medida que las plantas crezcan, realiza podas para mantener su forma y estimular un crecimiento más denso.
`;
