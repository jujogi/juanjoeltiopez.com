export default `
El **SL Aqua Z-1** (Planarian & Hydra Cleaner) es un tratamiento específico para el control de **planarias e hidras** en acuarios, muy utilizado en gambarios. Está formulado a base de **extractos herbales** y se aplica en un ciclo sencillo para reducir o eliminar estas plagas sin comprometer tu colonia bacteriana.

## Características
- Eficaz frente a **planarias** y **hidras**.
- Fórmula basada en **extractos naturales**.
- Compatible con **gambas, peces y plantas**.
- Tratamiento por **ciclos**, ideal para gambarios.
